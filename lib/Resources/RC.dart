    ...
    if (Commands.validation == "passed") {
      ...
      if (Commands.loc1 != null && Commands.name != null) {
        ...
        if (Commands.result != "")
          ...
          AppToast("Could not create Deployment");
      } else
        AppToast("No file found");
    } else
      AppToast("Server not connected");
                    ...
                    child: res == "RC"
                        ...
                        : Column(
                            children: [
                              Container(
                                  margin: EdgeInsets.only(
                                      top: 35, bottom: 5, left: 0, right: 0),
                                  alignment: Alignment.center,
                                  height: 50,
          ...
          actions: [
            ...
            Commands.isDone
                ...
                : IconButton(
                    ...
                    onPressed: res == "RC" ? CreateRC : CreateDep),
            SizedBox(width: 15),
          ],
        ),
        body: body,
