...
DockerPush() async {
  ...
  if (Commands.tag != null) {
    Commands.pushresult = await serverCredentials.client.execute(
        "sudo docker tag ${Commands.newImage}:${Commands.tag} ${Commands.uname}/${Commands.newImage}:${Commands.tag};sudo docker push ${Commands.uname}/${Commands.newImage}:${Commands.tag}");
  }
        ...
        if (Commands.image != null || Commands.newImage != null) {
          if (Commands.tag != null) {
            Commands.result = await serverCredentials.client.execute(
                "sudo docker commit ${Commands.name} ${Commands.newImage}:${Commands.tag}");
          } else {
            Commands.result = await serverCredentials.client.execute(
                "sudo docker commit ${Commands.name} ${Commands.newImage}");
          }
    ...
    DockerLogin() async {
      if (Commands.validation == "passed") {
        ...
        if (Commands.uname != null && Commands.passwd != null) {
          Commands.pushresult = await serverCredentials.client.execute(
              "sudo docker login -u ${Commands.uname} -p ${Commands.passwd}");
